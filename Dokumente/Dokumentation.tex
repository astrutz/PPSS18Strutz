...
\begin{document}
	...
	Im Folgenden wird eine Einleitung in die Domäne, die Problemstellung mit ihren Folgen, sowie den verwendeten Paradigmen gegeben. Anschließend wird aus dieser Recherche eine Forschungsfrage abgeleitet.
		...
		Im Folgenden werden Stakeholder nach ISO 15288:2015 \cite{ISO15288} vorgestellt, die einen Anteil, ein Anrecht, einen Anspruch oder ein Interesse am System haben.  \\
		Scrum Master, Entwickler, JIRA-Entwickler, Management von Firmen, Anteil (IT), Interesse von HR (Marketing), Scrum Evangelisten haben Interesse
